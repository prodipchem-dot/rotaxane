...
const MolecularGraph: React.FC = () => {
  ...
  return (
    <div className="w-full h-[500px] relative overflow-hidden rounded-3xl bg-slate-50 border border-slate-200 shadow-inner">
      <div className="absolute top-6 left-6 z-10 flex flex-col gap-1">
        <span className="text-purple-600 font-bold text-[10px] uppercase tracking-[0.3em]">Interactive Simulation</span>
        <h3 className="text-slate-900 font-bold text-xl">Artificial Trefoil Molecular Knot</h3>
      </div>
