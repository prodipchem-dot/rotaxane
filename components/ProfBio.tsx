          ...
          <div className="bg-[#660099] rounded-[3rem] p-10 overflow-hidden relative group shadow-lg">
            ...
            <div className="space-y-3">
              {[
                ...
                <a key={doc.label} href={doc.url} target="_blank" className="flex items-center justify-between p-4 bg-white/10 rounded-2xl border border-white/10 hover:bg-white transition-all group/item">
