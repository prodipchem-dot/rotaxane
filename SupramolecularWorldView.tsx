          ...
          <div className="w-full overflow-x-auto scrollbar-hide py-10">
            <div className="min-w-[1000px] md:min-w-0">
              ...
              >
                ...
                <g id="land-masses">
                  {/* Geographic paths maintained from original but with light mode land classes */}
                ...
                <g id="researchers">
                  {/* Individual researcher coordinates maintained from original dataset */}
                  ...
                  <a href="https://researchportal.hw.ac.uk/en/persons/amilra-de-silva" target="_blank" className="researcher-link">
                    <text x="445" y="186.0" style={{fontSize: '10px'}}>Amilra P. de Silva</text>
                  </a>
