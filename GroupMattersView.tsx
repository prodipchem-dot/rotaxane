      ...
      <section className="container mx-auto px-6">
        <div className="space-y-12">
            <div className="aspect-[21/9] rounded-[3rem] overflow-hidden border border-slate-200 shadow-xl relative bg-white">
                ...
                <div className="absolute bottom-8 left-8 p-4 bg-white/80 backdrop-blur rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="max-w-4xl mx-auto overflow-hidden rounded-3xl border border-slate-200 shadow-lg bg-white">
            <table className="w-full text-left text-sm text-slate-600">
                ...
                <tbody className="divide-y divide-slate-100">
                    {[
                      { res: "Safety Champion", monkey: "Flavio" },
                      { res: "Bay Bosses", monkey: "Enzo, Prodip, Maxime, Martin, Patrick, Flavio" },
                      { res: "IT & Webpage", monkey: "Maria" },
                      { res: "NMR", monkey: "Emily, Patrycja, Alex" },
                      { res: "MS", monkey: "Loli, Axel, Jannik, Jessica" },
                      { res: "HPLC", monkey: "Toufic, Joaquin" }
                    ].map((row, i) => (
                        <tr key={i} className="hover:bg-slate-50 transition-colors">
                            <td className="px-8 py-4 font-bold text-slate-900">{row.res}</td>
                            <td className="px-8 py-4">{row.monkey}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
                ...
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4 text-sm">
                    <p>
                        The Leigh Group have the use of a pair of Season Tickets for Manchester United at Old Trafford. 
