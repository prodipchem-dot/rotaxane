      ...
      <section className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
                ...
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-6">
                    <p>
                        ...
                        The lab consists of <span className="text-slate-900 font-bold">30 x 2m fumehoods</span> in the main lab and three adjacent instrument rooms.
                    </p>
                    <p>
            ...
            <div className="relative">
                <div className="absolute -inset-10 bg-purple-600/5 blur-3xl rounded-full"></div>
                <img src="https://www.catenane.net/images/general/vtourmap_web.jpg" alt="Lab Plan" className="relative z-10 w-full rounded-[3rem] border border-slate-100 shadow-2xl bg-white p-2" />
            </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 border-y border-slate-100 py-32">
        <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="bg-white border border-slate-100 p-8 rounded-[2.5rem] space-y-4 shadow-md">
                    <Zap className="text-[#ffcc00]" />
                    <h4 className="text-slate-900 font-bold serif italic">NMR Spectroscopy</h4>
                ...
                <div className="bg-white border border-slate-100 p-8 rounded-[2.5rem] space-y-4 shadow-md">
                    <Beaker className="text-[#660099]" />
                    <h4 className="text-slate-900 font-bold serif italic">Mass Spectrometry</h4>
                ...
                <div className="bg-white border border-slate-100 p-8 rounded-[2.5rem] space-y-4 shadow-md">
                    <FlaskConical className="text-[#ffcc00]" />
                    <h4 className="text-slate-900 font-bold serif italic">Synthesis</h4>
                ...
                <div className="bg-white border border-slate-100 p-8 rounded-[2.5rem] space-y-4 shadow-md">
                    <Microscope className="text-[#660099]" />
                    <h4 className="text-slate-900 font-bold serif italic">Crystallography</h4>
