...
const ResearchProjectView: React.FC<ResearchProjectViewProps> = ({ slug }) => {
      ...
      case 'gel-contraction':
        return (
          <div className="space-y-12">
            ...
            <div className="aspect-video bg-black rounded-[3rem] overflow-hidden border border-purple-500/30 shadow-2xl">
        ...
        return (
          <div className="space-y-12">
            ...
            <div className="grid gap-12 items-center">
                <div className="space-y-6 prose prose-invert text-slate-300 max-w-none">
                    ...
                    <img src={getMediaUrl("images/article_pictures/2022TapeReading/Turing.png")} className="w-full rounded-3xl border border-white/10" />
        ...
        return (
          <div className="space-y-12">
            ...
            <div className="prose prose-invert max-w-none text-slate-300 leading-relaxed">
                ...
                <img src={getMediaUrl("images/article_pictures/2022RotaryMotor/Feynman.png")} className="w-full rounded-3xl border border-white/10" />
  ...
  return (
    <div className="py-12 space-y-16">
                ...
                <nav className="flex flex-col gap-1 border-l border-white/5 pl-4">
                    {HIGHLIGHTS.map(h => (
                        ...
                        >
                            ...
                            {slug === h.slug && (
                                <div className="mt-2 h-0.5 w-4 bg-yellow-400"></div>
                            )}
                        </a>
                    ))}
                </nav>
      ...
      {/* MOBILE NAV (Bottom fixed or horizontal bar - only visible on small screens) */}
      <section className="lg:hidden bg-slate-950/90 backdrop-blur-xl border-t border-white/5 py-4 px-6 overflow-x-auto flex gap-6 scrollbar-hide">
        {HIGHLIGHTS.map(h => (
            <a key={h.slug} href={`#/research/${h.slug}`} className={`text-[9px] font-bold uppercase tracking-widest whitespace-nowrap ${slug === h.slug ? 'text-yellow-400' : 'text-slate-600'}`}>
                {h.title}
            </a>
        ))}
      </section>
