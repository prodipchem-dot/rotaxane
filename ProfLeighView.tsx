        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="relative">
               <div className="absolute -inset-4 bg-purple-600/5 blur-3xl rounded-full"></div>
               <img 
                 src="https://www.catenane.net/images/general/daveleigh2006.jpg" 
                 alt="Prof. Leigh" 
                 className="w-48 h-48 md:w-64 md:h-64 rounded-[3rem] object-cover relative z-10 border-2 border-slate-50 shadow-2xl"
               />
            </div>
